# Code to find dominant color of image using kmeans https://code.likeagirl.io/finding-dominant-colour-on-an-image-b4e075f98097
# I altered the code to use the webcam instead and also added a rectange around the area I wanted to find the dominant colors in
